  ...
  head: () => ({
    meta: [
      ...
      { title: "Harshwardhan More — Backend Software Engineer" },
      {
        name: "description",
        content:
          "Backend engineer building event-driven Node.js microservices, distributed systems, and production observability.",
      },
      { name: "author", content: "Harshwardhan More" },
  ...
  useEffect(() => {
    const onKey = (e: KeyboardEvent) => {
      ...
      if (e.key === "~" || (e.key === "`" && e.shiftKey)) {
        ...
        router.navigate({ to: cur === "/cli" ? "/" : "/cli" });
      }
    };
